...
const MODEL_SHOT_STRATEGIES = {
  h3: {
    ...
    "EP02-C01":"从专用抱收音机首帧起拍，稳定中近景慢推；抱耳倾听、检查、放回桌面依序完成，结尾双手和工具位置必须清楚。",
    "EP02-C02":"从C01同模型尾帧原位续拍，固定桌面轴线并以小幅横移跟随拆背板；动作宁慢勿跳，确保每颗螺丝、背板落点和双手连续。",
    "EP02-C03":"从C02同模型尾帧续拍，手部近景与眼睛拉焦各一次；两次微调之间必须停顿，广播碎片不能提前或增加信息。",
    "EP02-C04":"同空间新机位，三人站位锁定；用稳定三人中景完成问答、取包、背包、出门，完整拍到维修包来源与跨门槛动作。",
    "EP02-C05":"24mm晴天外景稳定侧跟，先读清天气和建筑，再让人物从画外走入、上台阶、推门进入；禁止跳切省略入门。",
    "EP02-C06":"柜台双人稳定中景，保持两人分处柜台两侧；视线摇到后仓电线后回到人物，最后沿固定通道离开，不改变空间轴线。",
    "EP02-C07":"以焦糊线路首帧锁定人物和故障点，稳定上摇看线、下摇取工具；关闭闸刀必须清楚完成，禁止火花、烟和大幅动作。",
    "EP02-C08":"从C07同模型尾帧续拍，近景检测后切回双人中景；解释、收工具、老板转身依序完成，焦糊线路保持未修状态。",
    "EP02-C09":"前6秒用稳定双人中景完成嘲笑和光线转暗，6秒后硬切雨滴特写；只出现一滴雨，最后拉焦到两人反应并停稳。"
  },
  grok: {
    ...
    "EP02-C01":"从专用首帧以轻微呼吸感推进，贴随抱起后的倾听和一次克制晃动，再顺势下降到桌面；运动最终完全停稳在双手与工具动作桥上。",
    "EP02-C02":"延续C01尾帧的运动方向，用贴近桌面的短弧线串联取螺丝刀、卸背板和检查内部；景深跟随手眼，但不跳过任何拆机步骤。",
    "EP02-C03":"由旋钮微距开始，随第一段广播拉焦到眼睛，再以小幅回环落回手部第二次微调；广播熄灭后沿抬眼动作自然带到晴窗。",
    "EP02-C04":"用轴线内缓慢侧移连接妻子问话与林国强回应，随后贴随他从桌下挂钩取包、背包并跨门离开；不得用剪切让工具包突然出现。",
    "EP02-C05":"以蓝天向下俯摇建立晴朗反差，接低位侧跟人物走近建筑；随脚步上台阶并轻推至门口，人物跨门后让镜头留在室外结束。",
    "EP02-C06":"从进门方向做克制横移建立柜台轴线，用一次视线引导滑向后仓明线并回到老板反应；随后平行跟随两人沿通道走向后门。",
    "EP02-C07":"由人物仰视顺势上摇到焦糊接点，利用前后景和门光展现仓库纵深；镜头再沿工具包动作下摇，跟随手臂回到闸刀和检测位置。",
    "EP02-C08":"紧接C07尾帧以小幅推近展示检测证据，再后退成双人纵深；老板转身后镜头不追出仓库，保留未修线路在前景作为危险伏笔。",
    "EP02-C09":"从后仓门向柜台做短距离随行，老板嘲笑时以云影改变光色；凉风声引导硬切微距雨滴，慢拉焦穿过水冠落到老板和林国强的相反表情。"
  }
};
const REFERENCE_NAMES = ["林国强","苏清禾","林小满","供销社老板","周永发","陈大海","郑文博","何秀英","高峰"];
...
const TASK_REFERENCE_ASSETS = {
  ...
  ,"EP02-C01": [
    { name:"林家土屋抱收音机", file:"林家土屋抱收音机首帧.jpg", kind:"本集专用开场首帧", anchor:"【0-2秒】", instruction:"以 @林家土屋抱收音机首帧.jpg 锁定抱机姿势、人物位置和新开场机位；" },
    { name:"1998破旧收音机", file:"1998破旧收音机道具三视图.jpg", kind:"固定道具图", anchor:"【0-2秒】", instruction:"以 @1998破旧收音机道具三视图.jpg 锁定木壳、天线、旋钮和磨损；" }
  ],
  "EP02-C02": [{ name:"1998破旧收音机", file:"1998破旧收音机道具三视图.jpg", kind:"固定道具图", anchor:"【0-2秒】", instruction:"以 @1998破旧收音机道具三视图.jpg 锁定拆机前后的道具结构；" }],
  "EP02-C03": [{ name:"1998破旧收音机", file:"1998破旧收音机道具三视图.jpg", kind:"固定道具图", anchor:"【0-2秒】", instruction:"以 @1998破旧收音机道具三视图.jpg 锁定旋钮和扬声器位置；" }],
  "EP02-C05": [{ name:"城南供销社晴天外景", file:"城南供销社外景_晴天母版.jpg", kind:"固定场景母版", anchor:"【0-2秒】", instruction:"以 @城南供销社外景_晴天母版.jpg 锁定建筑、街道、电线杆和晴天光向；" }],
  "EP02-C06": [{ name:"供销社柜台晴天内景", file:"城南供销社柜台内景_晴天母版.jpg", kind:"固定场景母版", anchor:"【0-2秒】", instruction:"以 @城南供销社柜台内景_晴天母版.jpg 锁定柜台、货架、门窗和后仓通道；" }],
  "EP02-C07": [{ name:"旧仓库焦糊线路", file:"供销社旧仓库_焦糊线路首帧.jpg", kind:"固定镜头首帧", anchor:"【0-2秒】", instruction:"以 @供销社旧仓库_焦糊线路首帧.jpg 锁定仓库、人物检查位置和焦糊接点；" }],
  "EP02-C08": [{ name:"旧仓库焦糊线路", file:"供销社旧仓库_焦糊线路首帧.jpg", kind:"场景与故障参考", anchor:"【0-2秒】", instruction:"以 @供销社旧仓库_焦糊线路首帧.jpg 保持仓库方向与同一焦糊接点；" }],
  "EP02-C09": [
    { name:"供销社柜台晴天内景", file:"城南供销社柜台内景_晴天母版.jpg", kind:"固定场景母版", anchor:"【0-2秒】", instruction:"以 @城南供销社柜台内景_晴天母版.jpg 锁定两人返回柜台的空间方向；" },
    { name:"第一滴雨落柜台", file:"第一滴雨落柜台_特写首帧.jpg", kind:"结尾钩子构图", anchor:"【6-8秒】", instruction:"以 @第一滴雨落柜台_特写首帧.jpg 锁定唯一雨滴、柜台近景和两人反应位置；" }
  ]
};
